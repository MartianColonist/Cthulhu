...
electronic (e.g. for atoms), rotation-vibration (most molecular 
...
centered at visible wavelengths near 0.6 μm with broad wings (a resonance doublet),
...
* Package grids of cross sections as a function of temperature and pressure into an HDF5 database to integrate with your favorite radiative transfer code.
